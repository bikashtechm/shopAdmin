...
This repository contains the code of the [Angular Material Course](https://angular-university.io/course/shop-admin).
...
We can install the master branch using the following commands:
    ...
    git clone https://github.com/angular-university/shop-admin.git
